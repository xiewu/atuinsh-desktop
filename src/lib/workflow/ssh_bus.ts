...
export default class SSHBus extends Emittery {
   ...
   */
  subscribeConnectionStatus(connectionString: string, callback: (status: ConnectionStatus) => void): () => void {
   ...
   */
  unsubscribeConnectionStatus(connectionString: string, callback: (status: ConnectionStatus) => void) {
   ...
   * @returns A function to unsubscribe
   */
  subscribeAnyConnectionStatus(callback: (data: { connectionString: string, status: ConnectionStatus }) => void): () => void {
   ...
   * @param callback - The callback to unsubscribe
   */
  unsubscribeAnyConnectionStatus(callback: (data: { connectionString: string, status: ConnectionStatus }) => void) {
